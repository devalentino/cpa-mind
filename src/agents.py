            ...
            initial_messages = [
                SystemMessage(
                    content=(
                        ...
                        "If OfferReader reveals landing URLs, call LandingReader for each landing "
                        "URL before drawing conclusions from the landing content. "
                        ...
                        "LandingReader output, not directly from the offer. Use the landing "
                        "analysis to identify the best concrete market phrase, determine the "
                        "target country, and express the search term in the local language used "
                        "in that country. For example, for Ukraine use a Ukrainian search phrase "
                        "and country code UA. If landing URLs are available, do not call "
                        "FacebookAdsLibraryReader until after at least one LandingReader call. "
